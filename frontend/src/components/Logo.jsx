  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        ...
        <line x1="20.5" y1="20.5" x2="24" y2="24" stroke="#818cf8" strokeWidth="2" strokeLinecap="round" />
      ...
      <div className="flex flex-col">
        ...
        <span className={`text-indigo-400 ${subtextSize}`}>AI Dependency Intelligence</span>
      </div>
    </div>
  );
};
